...
void init_gdt(void) {
    ...
    init_gdt_desc(0x30000, 0x0, 0xFF, 0x0D, &kgdt[4]); // USER CODe
    init_gdt_desc(0x30000, 0x0, 0xF3, 0x0D, &kgdt[5]); // USER DATA
    init_gdt_desc(0x0, 0x20, 0xF7, 0x0D, &kgdt[6]); // USER STACK
